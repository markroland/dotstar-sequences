# From https://github.com/adafruit/Adafruit_Learning_System_Guides/blob/master/CircuitPython_Essentials/CircuitPython_DotStar.py
...
num_pixels = 120
pixels = adafruit_dotstar.DotStar(board.SCK, board.MOSI, 120, brightness=0.2, auto_write=False)
